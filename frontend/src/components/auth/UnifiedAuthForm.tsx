      ...
      >
        ...
        <div className="px-6 pt-6 pb-4 text-center">
          ...
          <p className="mt-1 text-xs text-gray-600">
            {GOOGLE_ONLY_AUTH ? 'Use Google to sign in securely. No password required.' : activeTab === 'login' ? 'Sign in to continue' : 'Join us to get started'}
          </p>
        </div>
        ...
        <div className="px-6 pb-6">
          {GOOGLE_ONLY_AUTH ? (
            <div className="space-y-4">
              <div className="rounded-xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-amber-50 p-4">
                <div className="grid grid-cols-1 gap-2 text-xs text-gray-700">
                  <div className="flex items-center gap-2">
                    <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-orange-100 text-orange-700">✓</span>
                    <span>One tap sign-in (no password)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-orange-100 text-orange-700">✓</span>
                    <span>Faster access across devices</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-orange-100 text-orange-700">✓</span>
                    <span>Secure account protection by Google</span>
                  </div>
                </div>
              </div>
              ...
              >
                {isGoogleLoading ? (
                  ...
                  <>
                    <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-50 border border-gray-200 group-hover:bg-white transition">
